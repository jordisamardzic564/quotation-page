...
export default function SuccessView({ data }: SuccessViewProps) {
  ...
  return (
    <div className="min-h-screen bg-[#161616] text-[#EDEDED] font-sans selection:bg-[#D4F846] selection:text-black overflow-x-hidden flex flex-col">
      ...
      {/* Navbar (Simplified) */}
      <nav className="w-full z-40 bg-[#161616]/90 backdrop-blur-sm border-b border-[#333]">
        ...
        <div className="max-w-4xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
                <div className="mb-8 relative">
                    ...
                    <h1 className="text-4xl md:text-5xl tracking-tight mb-4 text-white" style={{ fontFamily: 'Ppmonumentextended, sans-serif' }}>
                        Production<br/>
                        <span className="text-[#D4F846]">Slot Secured</span>
                    </h1>
                    
                    <p className="text-[#888] text-sm md:text-base leading-relaxed font-mono max-w-md">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <button className="flex items-center justify-center gap-3 px-6 py-4 bg-[#111] border border-[#333] text-[#EDEDED] hover:border-[#D4F846] hover:text-[#D4F846] transition-all group w-full sm:w-auto">
            ...
            >
                ...
                >
                    <div className="p-8 relative">
                        {/* Receipt Header */}
                        <div className="flex justify-between items-start mb-8 pb-6 border-b border-[#222]">
                            <div>
                                <div className="text-[10px] text-[#666] uppercase font-mono tracking-widest mb-1">Receipt for</div>
                                <div className="text-sm font-bold text-[#EDEDED]">{data.klant_naam}</div>
                            </div>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex justify-between items-center">
                                <span className="text-xs text-[#888] font-mono uppercase">Configuration ID</span>
                                <span className="text-xs text-[#EDEDED] font-mono">{displayId}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-xs text-[#888] font-mono uppercase">Vehicle</span>
                                <span className="text-xs text-[#EDEDED] font-mono">{data.voertuig}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-xs text-[#888] font-mono uppercase">Payment Status</span>
                        ...
                        {/* Total */}
                        <div className="bg-[#161616] p-6 rounded border border-[#222]">
                            <div className="flex justify-between items-end">
                                <span className="text-xs text-[#666] font-mono uppercase mb-1">{paymentLabel}</span>
                                <span className="text-2xl text-[#D4F846]" style={{ fontFamily: 'Ppmonumentextended, sans-serif' }}>
                                    {formatCurrency(paidAmount, data.valuta)}
                                </span>
                            </div>
                            {!isFullPayment && (
                                <div className="mt-2 text-[10px] text-[#444] font-mono text-right">
                        ...
                        {/* Decorative Barcode */}
                        <div className="mt-8 pt-6 border-t border-[#222] flex justify-between items-end opacity-40">
                            ...
                            <span className="font-mono text-[10px] text-[#666]">AUTH: {Math.random().toString(36).substr(2, 9).toUpperCase()}</span>
                        </div>
                    </div>
                </MagicCard>
            </motion.div>
      ...
      {/* Footer */}
      <footer className="py-8 border-t border-[#222] bg-[#111]">
         <div className="max-w-[1280px] mx-auto px-4 md:px-12 text-center text-[10px] text-[#444] font-mono uppercase tracking-widest">
